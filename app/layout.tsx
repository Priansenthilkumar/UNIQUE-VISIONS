...
import { Inter, Montserrat, Poppins, Cinzel, Playfair_Display, Space_Grotesk, DM_Sans } from 'next/font/google'
import './globals.css'
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`scroll-smooth ${inter.variable} ${montserrat.variable} ${poppins.variable} ${cinzel.variable} ${playfair.variable} ${spaceGrotesk.variable} ${dmSans.variable}`}>
