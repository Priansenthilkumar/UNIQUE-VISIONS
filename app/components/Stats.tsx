      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-syne font-extrabold text-[clamp(2.2rem,5vw,3.8rem)] text-white leading-tight">
            By The <span className="gradient-text-gold">Numbers</span>
          </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="luxury-card p-8 text-center border border-white/10 hover:border-amber-500/40 bg-[#0D0D14]"
            >
              ...
              <div className="w-10 h-0.5 bg-amber-500/30 mx-auto my-3 rounded-full" />
        ...
        {/* CTA Banner */}
        <div className="luxury-card-gold p-10 md:p-14 text-center relative overflow-hidden border border-amber-500/40 bg-gradient-to-r from-[#14141E] via-[#0D0D14] to-[#070709]">
          ...
          <p className="font-jakarta text-slate-300 text-base max-w-xl mx-auto mb-8 leading-relaxed">
            Join 10+ businesses already growing with Unique Visions. Let's create high-converting visual campaigns together.
          </p>
          <button
