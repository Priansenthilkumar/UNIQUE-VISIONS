...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="bg-[#060D0A] text-slate-100 font-jakarta">
        {/* 1. Hero Section */}
        <Hero />
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16">
              ...
              <h2 className="font-syne font-extrabold text-[clamp(2.2rem,5vw,3.8rem)] text-white leading-tight">
                Everything You Need To <span className="gradient-text-emerald">Scale Digital Growth</span>
              </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div
                ...
                className="glass-card p-8 border border-white/10 hover:border-emerald-500/40 bg-gradient-to-b from-[#0A1410]/90 to-[#0F1F19]/90 cursor-pointer group flex flex-col justify-between transition-all"
              >
                <div>
                  ...
                  <h3 className="font-syne font-bold text-2xl text-white mb-2 group-hover:text-emerald-400 transition-colors">
                    About Us
                  </h3>
              ...
              <div
                ...
                className="glass-card p-8 border border-white/10 hover:border-amber-500/40 bg-gradient-to-b from-[#14100A]/90 to-[#1F190F]/90 cursor-pointer group flex flex-col justify-between transition-all"
              >
                <div>
              ...
              <div
                ...
                className="glass-card p-8 border border-white/10 hover:border-emerald-500/40 bg-gradient-to-b from-[#0A1410]/90 to-[#0F1F19]/90 cursor-pointer group flex flex-col justify-between transition-all sm:col-span-2 lg:col-span-2"
              >
                <div>
                  <div className="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        <section className="py-20 bg-[#0A1410] border-t border-white/10">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="font-jakarta text-slate-400 text-base md:text-lg mb-8 max-w-xl mx-auto">
